export let Borders = {
    HTML: `  <span class="border border-container"></span>
...
export let Removeborders = {
    HTML: `   <span class="border-0 border-container"></span>
...
export let BorderWidths = {
    HTML: ` <span class="border border-container border-primary"></span>
...
export let Borderwithopacity = {
    HTML: `  <div class="border border-success p-2 mb-2">This is default success border</div>
...
export let BorderRadius = {
    HTML: ` <img src="./assets/images/media/media-58.jpg" class="bd-placeholder-img rounded" alt="...">
...
export let Sizes = {
    HTML: `     <img src="./assets/images/media/media-58.jpg" class="bd-placeholder-img bd-placeholder-img rounded-0" alt="...">
