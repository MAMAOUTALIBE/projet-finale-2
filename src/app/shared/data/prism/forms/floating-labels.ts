export let
  ...
  FloatingLabelsInSelect= {
    html: ` <div class="form-floating w-100">
                <mat-form-field class="form-floating">
                    <mat-label>Works with selects</mat-label>
                    <mat-select placeholder="Open this select menu">
  ...
  FloatingLabelsWithPreDefinedValues= {
    html: ` <form class="form-floating my-3">
