export let
  ...
  Segmentedbuttons = {
    html: ` <div class="input-group mb-3" ngbDropdown>
                        ...
                        <ul class="dropdown-menu" ngbDropdownMenu>
                            <li><a class="dropdown-item" ngbDropdownItem href="javascript:void(0);">Action</a></li>
                            <li><a class="dropdown-item" ngbDropdownItem href="javascript:void(0);">Another action</a>
                            </li>
                            <li><a class="dropdown-item" ngbDropdownItem href="javascript:void(0);">Something else
                                    here</a></li>
                            <li>
                                <hr class="dropdown-divider">
                            </li>
                            <li><a class="dropdown-item" ngbDropdownItem href="javascript:void(0);">Separated link</a>
                            </li>
                        </ul>
...
`
  ...
  Buttonsaddons = {
    html: `<div class="input-group mb-3">
                    ...
                    <div class="input-group mb-3"> <button class="btn btn-primary" type="button"
                            id="button-addon">Button</button> <input type="text" class="form-control"
                            placeholder="Recipient's username" aria-label="Recipient's username"
                            aria-describedby="button-addon"> </div>
                    <div class="input-group mb-3">
                        <button class="btn btn-primary" type="button">Button</button>
                        <button class="btn btn-primary" type="button">Button</button>
                        <input type="text" class="form-control" placeholder=""
  ...
  Buttonswithdropdown = {
    html: `<div class="input-group mb-3" ngbDropdown>
                    ...
                    <div class="input-group input-btn-outline mb-3" ngbDropdown>
                        <input type="text" class="form-control" aria-label="Text input with dropdown button">
                        <button class="btn btn-outline-primary dropdown-toggle" ngbDropdownToggle type="button"
                            data-bs-toggle="dropdown" aria-expanded="false">Dropdown</button>
                        <ul class="dropdown-menu dropdown-menu-end" ngbDropdownMenu>
                            <li><a class="dropdown-item" ngbDropdownItem href="javascript:void(0);">Action</a></li>
                            <li><a class="dropdown-item" ngbDropdownItem href="javascript:void(0);">Another action</a>
                    ...
                    <div ngbDropdown class="input-group flex-nowrap">
                        <button ngbDropdownToggle class="btn btn-primary-transparent dropdown-toggle"
