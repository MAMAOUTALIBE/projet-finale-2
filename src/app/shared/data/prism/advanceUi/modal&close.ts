export let BasicModal = {
    Html: ` <button (click)="openBasic(basicModal)" type="button" class="btn btn-primary" data-bs-toggle="modal"
            ...
            <ng-template #basicModal let-modal>
                <div class="modal-header">
                    ...
                    <a type="button" class="btn-close" data-bs-dismiss="modal" (click)="modal.dismiss('Cross click')"
                        aria-label="Close"></a>
                </div>
...
@Component({
  selector: 'app-modal-closes',
  imports: [FormsModule,ReactiveFormsModule],
  templateUrl: './modal-closes.html',
  styleUrl: './modal-closes.scss'
})
export class ModalClosesComponent {
...
export let Staticbackdrop = {
    Html: ` <button (click)="StaticBackdrop(staticbackdropModal)" type="button" class="btn btn-primary"
...
export let Scrollinglongcontent = {
    Html: ` <button (click)="scrollableContent(ScrollingcontentModal)" type="button" class="btn btn-primary"
                data-bs-toggle="modal" data-bs-target="#exampleModalScrollable">
                Scrolling long content
            </button>
            <ng-template #ScrollingcontentModal let-modal>
                <div class="modal-header">
...
export let Verticallycenteredmodal = {
    Html: ` <button (click)="VerticalCenter(VerticalCenterModal)" type="button" class="btn btn-primary"
                data-bs-toggle="modal" data-bs-target="#exampleModalScrollable2">
                Vertically centered modal
            </button>
            <ng-template #VerticalCenterModal let-modal>
                <div class="modal-header">
                ...
                <div class="modal-footer">
                    <a (click)="modal.close('Save click')" type="button" class="btn btn-secondary"
...
export let VerticalCenteredScrollable = {
    Html: ` <button type="button" (click)="VerticalCenterScroll(VerticalCenterScrollModal)" class="btn btn-primary"
                data-bs-toggle="modal" data-bs-target="#exampleModalScrollable3">
                Vertically centered scrollable modal
            </button>
            <ng-template #VerticalCenterScrollModal let-modal>
                <div class="modal-header">
...
export let Tooltipsandpopovers = {
    Html: ` <button (click)="TooltipPopovers(TooltipPopoversModal)" type="button" class="btn btn-primary"
                data-bs-toggle="modal" data-bs-target="#exampleModalScrollable4">
                Launch demo modal
            </button>
            <ng-template #TooltipPopoversModal let-modal>
                <div class="modal-header">
                ...
                <div class="modal-body">
                    ...
                    <p>
                        This
                        <a role="button" class="btn btn-secondary" placement="bottom" popoverTitle="Popover Bottom"
                    ...
                    <p>
                        <a class="text-primary" ngbTooltip="tooltip" title="Tooltip">This link</a>
                        and
                        <a class="text-primary" ngbTooltip="tooltip" title="Tooltip">that link</a>

                        have tooltips on hover.
                    </p>
                </div>
                <div class="modal-footer">
                    <a type="button" (click)="modal.close('Save click')" class="btn btn-secondary"
                        data-bs-dismiss="modal">
                        Close
                    </a>
                    <button type="button" class="btn btn-primary">Save Changes</button>
...
export let Usingthegrid = {
    Html: `  <button (click)="Gridmodal(GridCenterModal)" type="button" class="btn btn-primary" data-bs-toggle="modal"
                data-bs-target="#exampleModalScrollable5">
                Launch demo modal
            </button>
            <ng-template #GridCenterModal let-modal>
                <div class="modal-header">
...
export let Togglebetweenmodals = {
    Html: ` <a (click)="openFirstModal(content1)" class="btn btn-primary" data-bs-toggle="modal" role="button">Open
                first modal
            </a>
            <ng-template #content1 let-modal>
                <div class="modal-header">
                    <h6 class="modal-title">Modal 1</h6>
                    <a type="button" class="btn-close" (click)="modal.dismiss('Cross click')"></a>
                </div>
                <div class="modal-body">
                    Show a second modal and hide this one with the button below.
                </div>
                <div class="modal-footer">
                    <button class="btn btn-primary" (click)="openSecondModal(content1, content2)">
                        Open second modal
                    </button>
                </div>
            </ng-template>
...
export let Optionalsizes = {
    Html: `  <button (click)="openXl(XlContentModal)" type="button" class="btn btn-primary m-1" data-bs-toggle="modal"
                data-bs-target="#exampleModalXl">
                Extra large modal
            </button>
            <button (click)="openLg(LargeModal)" type="button" class="btn btn-secondary m-1" data-bs-toggle="modal"
                data-bs-target="#exampleModalLg">
                Large modal
            </button>
            <button (click)="openSm(SmallModal)" type="button" class="btn btn-warning m-1" data-bs-toggle="modal"
...
export let Fullscreenmodal = {
    Html: ` <div class="bd-example">
                <button (click)="openFullscreen(FullscreenModal)" type="button" class="btn btn-primary mb-1 me-1"
                    data-bs-toggle="modal" data-bs-target="#exampleModalFullscreen">
                    Full screen
                </button>
                <button (click)="BelowSm(BelowSmModal)" type="button" class="btn btn-secondary mb-1 me-1"
                    data-bs-toggle="modal" data-bs-target="#exampleModalFullscreenSm">
                    Full screen below sm
                </button>
                <button (click)="BelowMd(BelowMdModal)" type="button" class="btn btn-warning mb-1 me-1"
                    data-bs-toggle="modal" data-bs-target="#exampleModalFullscreenMd">
                    Full screen below md
                </button>
                <button (click)="BelowLg(BelowLgModal)" type="button" class="btn btn-info mb-1 me-1"
                    data-bs-toggle="modal" data-bs-target="#exampleModalFullscreenLg">
                    Full screen below lg
                </button>
                <button (click)="BelowXl(BelowXlModal)" type="button" class="btn btn-success mb-1 me-1"
                    data-bs-toggle="modal" data-bs-target="#exampleModalFullscreenXl">
                    Full screen below xl
                </button>
                <button type="button" (click)="BelowXxl(BelowXxlModal)" class="btn btn-danger mb-1 me-1"
                    data-bs-toggle="modal" data-bs-target="#exampleModalFullscreenXxl">
...
export let Varyingmodalcontent = {
    Html: `  <button (click)="Openmdo(OpenmdoModal)" type="button" class="btn btn-primary mb-1 me-1"
                data-bs-toggle="modal" data-bs-target="#formmodal" data-bs-whatever="&#64;mdo">
                Open modal for &#64;mdo
            </button>
            <button type="button" (click)="Openfat(OpenfatModal)" class="btn btn-secondary mb-1 me-1"
                data-bs-toggle="modal" data-bs-target="#formmodal" data-bs-whatever="&#64;fat">
                Open modal for &#64;fat
            </button>
            <button (click)="Opengetbootstrap(OpengetbootstrapModal)" type="button" class="btn btn-light mb-1 me-1"
                data-bs-toggle="modal" data-bs-target="#formmodal" data-bs-whatever="&#64;getbootstrap">
                ...
                <div class="modal-body">
                    <form>
                        <div class="mb-3">
                            ...
                            <input value="&#64;mdo" type="text" class="form-control" id="recipient-name" />
                        </div>
                        <div class="mb-3">
            ...
            <ng-template #OpenfatModal let-modal>
                ...
                <div class="modal-body">
                    <form>
                        <div class="mb-3">
                            <label for="recipient-name" class="col-form-label">Recipient:</label>
                            <input value="&#64;fat" type="text" class="form-control" id="recipient-name" />
                        </div>
                        <div class="mb-3">
                            <label for="message-text" class="col-form-label">Message:</label>
                            <textarea class="form-control" id="message-text"></textarea>
            ...
            <ng-template #OpengetbootstrapModal let-modal>
                ...
                <div class="modal-body">
                    <form>
                        <div class="mb-3">
                            <label for="recipient-name" class="col-form-label">Recipient:</label>
                            <input value="&#64;getbootstrap" type="text" class="form-control" id="recipient-name" />
                        </div>
                        <div class="mb-3">
                            <label for="message-text" class="col-form-label">Message:</label>
                            <textarea class="form-control" id="message-text"></textarea>
...
export let ModalAnimationEffects = {
    Html: `    <div class="row">
...
<ng-template #scale let-modal>
    ...
    <div class="modal-footer">
        <button type="button" class="btn ripple btn-primary">Save changes</button>
        <a type="button" class="btn ripple btn-secondary" (click)="modal.close('Save click')">
            Close
        </a>
    </div>
</ng-template>
