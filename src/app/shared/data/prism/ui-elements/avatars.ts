export let Avatars = {
    Html: `     <span class="avatar me-2 avatar-radius-0"> 
...
export let AvatarSizes = {
    Html: `  <span class="avatar avatar-xs me-2">
...
export let AvatarWithIcons = {
    Html: `   <span class="avatar avatar-xs me-2 avatar-rounded">
                    <img src="./assets/images/faces/2.jpg" alt="img">
...
export let AvatarWithOnlineStatusIndicators = {
    Html: ` 
...
export let AvatarWithOfflineStatusIndicators = {
    Html: `                <span class="avatar avatar-xs me-2 offline avatar-rounded">
                    <img src="./assets/images/faces/2.jpg" alt="img">
                </span>
...
export let AvatarsWithNumberBadges = {
    Html: `
...
export let AvatarWithInitials = {
    Html: ` <span class="avatar avatar-xs m-2 bg-primary">
                    xs
                </span>
...
export let RoundedStackedAvatars = {
    Html: ` 
