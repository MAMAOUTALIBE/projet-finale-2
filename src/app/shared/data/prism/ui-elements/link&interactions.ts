export let TEXTSELECTION = {
    Html: `     <p class="user-select-all">This paragraph will be entirely selected when clicked by the user.</p>
...
@Component({
  ...
  imports: [],
  templateUrl: './links-interactions.html',
  styleUrl: './links-interactions.scss'
})
...
export let POINTEREVENTS = {
    Html: ` <p><a href="javascript:void(0)" class="pe-none text-primary fw-medium text-decoration-underline" tabindex="-1">This link</a> can not be clicked.</p>
...
export let LINKOPACITY = {
    Html: `         <p><a class="link-opacity-10" href="javascript:void(0)">Link opacity 10</a></p>
...
export let LINKHOVERVARIANT = {
    Html: `    <a class="link-offset-2 link-offset-3-hover link-underline link-underline-opacity-0 link-underline-opacity-75-hover text-decoration-underline" href="javascript:void(0)">
                            Underline opacity 0
                        </a> `,
    Ts: `
import { Component } from '@angular/core';
...
export let LINKUNDERLINECOLORS = {
    Html: `  <p><a href="javascript:void(0)" class="link-underline-primary text-decoration-underline">Primary underline</a></p>
...
export let LINKUNDERLINEOFFSET = {
    Html: `     <p><a href="javascript:void(0)" class="text-decoration-underline">Default link</a></p>
...
export let LINKUNDERLINEOPACITY = {
    Html: ` <p><a class="text-decoration-underline link-offset-2 link-underline link-underline-opacity-0" href="javascript:void(0)">Underline opacity 0</a></p>
...
export let LINKHOVEROPACITY = {
    Html: `  <p><a class="link-opacity-10-hover" href="javascript:void(0)">Link hover opacity 10</a></p>
...
export let COLOREDLINKS = {
    Html: ` <p><a href="javascript:void(0)" class="link-primary link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover text-decoration-underline">Primary link</a></p>
