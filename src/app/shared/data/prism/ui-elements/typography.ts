export let HeadingsHtags = {
    Html: `    <h1 class="mb-3">h1. Bootstrap heading</h1>
...
export let HeadingClassNames = {
    Html: `   <p class="h1 mb-3">h1. Bootstrap heading</p>
...
export let Customizingheadings = {
    Html: `<h3>
...
export let FontSizes = {
    Html: ` <p class="fs-1 mb-2">.fs-1 text</p>
...
export let LeadParagraph = {
    Html: `<p class="lead mb-0">
...
export let Blockquotes = {
    Html: `   <figure class="blockquote-container">
...
export let RightAligned = {
    Html: `  <figure class="blockquote-container text-end">
                <blockquote class="blockquote mb-2">
                    <h6>The greatest glory in living lies not in never falling, but in rising every time we fall.</h6>
                </blockquote>
                <figcaption class="blockquote-footer mt-0 mb-0 text-muted op-7"><cite title="Source Title">Nelson
...
export let CustomBlockquotes = {
    Html: `  <blockquote class="blockquote custom-blockquote primary mb-0 text-center">
...
export let SecondaryBlockquote = {
    Html: ` <blockquote class="blockquote custom-blockquote secondary mb-0 text-center">
                <h6>The future belongs to those who believe in the beauty of their dreams..</h6>
                <footer class="blockquote-footer mt-3 fs-14 text-muted op-7 mb-0">Someone famous as <cite
                        title="Source Title">-Eleanor Roosevelt</cite></footer>
                <span class="quote-icon"><i class="ri-information-line"></i></span>
...
export let WarningBlockquote = {
    Html: ` <blockquote class="blockquote custom-blockquote warning mb-0 text-center">
                <h6>The future belongs to those who believe in the beauty of their dreams..</h6>
                <footer class="blockquote-footer mt-3 fs-14 text-muted op-7 mb-0">Someone famous as <cite
                        title="Source Title">-Eleanor Roosevelt</cite></footer>
                <span class="quote-icon"><i class="ri-information-line"></i></span>
...
export let SuccessBlockquote = {
    Html: `<blockquote class="blockquote custom-blockquote success mb-0 text-center">
                <h6>The future belongs to those who believe in the beauty of their dreams..</h6>
                <footer class="blockquote-footer mt-3 fs-14 text-muted op-7 mb-0">Someone famous as <cite
                        title="Source Title">-Eleanor Roosevelt</cite></footer>
                <span class="quote-icon"><i class="ri-information-line"></i></span>
...
export let InfoBlockquote = {
    Html: `  <blockquote class="blockquote custom-blockquote info mb-0 text-center">
                <h6>The future belongs to those who believe in the beauty of their dreams..</h6>
                <footer class="blockquote-footer mt-3 fs-14 text-muted op-7 mb-0">Someone famous as <cite
                        title="Source Title">-Eleanor Roosevelt</cite></footer>
                <span class="quote-icon"><i class="ri-information-line"></i></span>
...
export let DangerBlockquote = {
    Html: `  <blockquote class="blockquote custom-blockquote danger mb-0 text-center">
                <h6>The future belongs to those who believe in the beauty of their dreams..</h6>
                <footer class="blockquote-footer mt-3 fs-14 text-muted op-7 mb-0">Someone famous as <cite
                        title="Source Title">-Eleanor Roosevelt</cite></footer>
                <span class="quote-icon"><i class="ri-information-line"></i></span>
...
export let DescriptionlistAlignment = {
...
export let Horizontalrules = {
    Html: `<p class="mb-1">Lorem ipsum dolor sit amet consectetur adipisicing elit. Rerum dolorem fuga iste obcaecati
...
export let Textdecoration = {
    Html: `<p class="text-decoration-underline">This text has a line underneath it.
            </p>
...
export let Fontweightanditalics = {
    Html: `  <p class="fw-bold">Bold text.</p>
...
export let Lineheight = {
    Html: `   <p class="lh-1">This is a long paragraph written to show how the line-height of
                an
...
export let Monospace = {
    Html: `             <p class="font-monospace mb-0">This is in monospace</p>
 `,
    Ts: `
import { Component } from '@angular/core';
...
export let Visibletext = {
    Html: `            <p class="visible mb-0">This is visible text</p>
  `,
    Ts: `
import { Component } from '@angular/core';
...
export let Invisibletext = {
    Html: `            <p class="invisible mb-0">This is invisible text</p>
  `,
    Ts: `
import { Component } from '@angular/core';
...
export let Textwrappingandoverflow = {
    Html: ` <div class="badge bg-primary text-wrap mb-3" style="width: 6rem;">
