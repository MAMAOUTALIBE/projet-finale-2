export let TooltipDirections = {
    Html: ` <div class="btn-list">
                @for(tooltip of DirectionsTooltip;track tooltip){
                <button type="button" class="btn btn-primary btn-wave" data-bs-toggle="tooltip"
                    placement="{{tooltip.placement}}" ngbTooltip="{{tooltip.title}}">
                    {{tooltip.title}}
                </button> }
            </div>  `,
    Ts: `
...
export let ColoredTooltips = {
    Html: ` <div class="btn-list">
                @for(tooltip of ColorTooltip;track tooltip){
                <button type="button" class="{{tooltip.buttonClass}}" data-bs-toggle="tooltip"
                    tooltipClass="{{tooltip.color}}" placement="auto" ngbTooltip="{{tooltip.title}}">
                    {{tooltip.title}}
                </button>
                }
            </div> `,
...
export let Tooltipsonlinks = {
    Html: `  <p class="text-muted mb-0">
                Hover on the link to view the <a href="javascript:void(0);" data-bs-toggle="tooltip"
                    class="tooltip-primary" ngbTooltip="Link Tooltip" tooltipClass="tooltip-primary">Tooltip</a>
            </p> `,
    Ts: `
import { Component } from '@angular/core';
...
export let WithanSVG = {
    Html: `  <a href="javascript:void(0);" data-bs-toggle="tooltip" ngbTooltip="Home" tooltipClass="tooltip-primary"
...
export let Disabledelements = {
    Html: `   <span class="d-inline-block" tabindex="0" data-bs-toggle="tooltip" ngbTooltip="Disabled tooltip">
...
export let TooltipForImages = {
    Html: `  @for(tooltip of imagesTooltip;track tooltip){
            <a href="javascript:void(0);" data-bs-toggle="tooltip" ngbTooltip="{{tooltip.title}}"
                tooltipClass="tooltip-primary" class="{{tooltip.buttonClass}}">
                <img src="{{tooltip.images}}" alt="img">
            </a>
            }  `,
    Ts: `
import { Component } from '@angular/core';
