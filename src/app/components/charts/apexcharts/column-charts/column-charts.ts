...
interface YearData {
  x: string;              // year, e.g., "2011"
  y: number;              // yearly total
  color: string;          // color reference
  quarters: QuarterData[]; // array of quarters
}

var colors = ['#38cab3', '#38cab3', '#ffbd5a', '#4ec2f0', '#f34343', '#24d5b8', '#5b67c7'];

@Component({
  selector: 'app-column-charts',
  imports: [SpkApexcharts],
  templateUrl: './column-charts.html',
  styleUrl: './column-charts.scss'
})
export class ColumnCharts {
  BasicColumnChart: ApexOptions = {
    series: [{
      name: 'Net Profit',
  ...
  ColumnChartWithDataLabels: ApexOptions = {
    series: [{
      name: 'Inflation',
  ...
  StackedColumnChart: ApexOptions = {
    series: [{
      name: 'PRODUCT A',
    ...
    colors: ["#38cab3", "#38cab3", "#ffbd5a", "#f34343"],
    responsive: [{
      breakpoint: 480,
      options: {
        legend: {
  ...
  StackedColumnChart100: ApexOptions = {
    series: [{
      name: 'PRODUCT A',
  ...
  ColumnChartWithMarkers: ApexOptions = {
    series: [
      {
        name: 'Actual',
        data: [
  ...
  ColumnChartWithRotatedLabels: ApexOptions = {
    series: [{
      name: 'Servings',
  ...
  ColumnChartWithNegativeValues: ApexOptions = {
    series: [{
      name: 'Cash Flow',
  ...
  public makeData(): YearData[] {
    var dataSet = this.shuffleArray(arrayData);

    var dataYearSeries: YearData[] = [
      {
        x: "2011",
        y: dataSet[0].y,
        color: colors[0],
  ...
  DynamicLoadedChart1: ApexOptions = {
    series: [
      {
        name: "year",
        data: this.makeData()
  ...
  DynamicLoadedChart2: ApexOptions = {
    series: [
      {
        name: "quarter",
        data: []
  ...
  DistributedColumnsChart: ApexOptions = {
    series: [{
    ...
    colors: ['#38cab3', '#38cab3', '#ffbd5a', '#4ec2f0', '#f34343', '#24d5b8', '#5b67c7', '#a65e76'],
    plotOptions: {
      bar: {
        columnWidth: '45%',
        distributed: true,
    ...
    xaxis: {
      ...
      labels: {
        style: {
          colors: ['#38cab3', '#38cab3', '#ffbd5a', '#4ec2f0', '#f34343', '#24d5b8', '#5b67c7'],
          fontSize: '12px'
        }
      }
    },
