...
@Component({
  ...
  styleUrl: './candlestickcharts.scss'
})
export class Candlestickcharts {


  BasicCandlestickChart: ApexOptions = {
    series: [{
      data: [{
  ...
  CandlestickSyncedChart: ApexOptions = {
    series: [{
      data: seriesData
    }],
    chart: {
  ...
  CandlestickBrushChart: ApexOptions = {
    series: [{
      name: 'volume',
  ...
  CandlestickWithCateoryXaxis: ApexOptions = {
    series: [{
      name: 'candle',
      data: [
        {
  ...
  CandlestickWithLineChart: ApexOptions = {
    series: [{
      name: 'line',
      type: 'line',
      data: [
