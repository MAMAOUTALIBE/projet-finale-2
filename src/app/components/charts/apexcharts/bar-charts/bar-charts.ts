...
export class BarCharts {
  ...
  StackedBarChart: ApexOptions = {
    ...
    colors: ["#38cab3", "#4ec2f0", "#ffbd5a", "#fe5454", "#0ca3e7"],
    grid: {
      borderColor: '#f2f5f7',
    },
    title: {
  ...
  StackedBarChart100: ApexOptions = {
    series: [{
      name: 'Marine Sprite',
      data: [44, 55, 41, 37, 22, 43, 21]
    }, {
  ...
  BarChartWithNegativeValues: ApexOptions = {
    series: [
      {
        name: 'Males',
        data: [
  ...
  BarChartWithMarkers: ApexOptions = {
    series: [
      {
        name: 'Actual',
        data: [
  ...
  BarWithCategoryDataLabels: ApexOptions = {
    series: [{
      data: [400, 430, 448, 470, 540, 580, 690, 1100, 1200, 1380]
    }],
    chart: {
    ...
    colors: ["#38cab3", "#4ec2f0", "#ffbd5a", "#fe5454", "#0ca3e7", "#fc6c85", "#8f00ff", "#a65e9a",
      "#2ecc71", "#4ec2f0"
    ],
    grid: {
      borderColor: '#f2f5f7',
