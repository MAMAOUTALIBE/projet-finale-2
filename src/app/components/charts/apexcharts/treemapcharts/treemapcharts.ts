...
@Component({
  ...
  styleUrl: './treemapcharts.scss'
})
export class Treemapcharts {


  BasicTreemapChart: ApexOptions = {
    series: [
      {
        data: [
          {
  ...
  MultiDimensionalTreemapChart: ApexOptions = {
    series: [
      {
        name: 'Desktops',
        data: [
  ...
  DistributedTreemapChart: ApexOptions = {
    series: [
      {
        data: [
          {
  ...
  Treemapwithcolorranges: ApexOptions = {
    series: [
      {
        data: [
          {
