...
@Component({
  ...
  imports: [FormsModule, ReactiveFormsModule, LightboxModule, GalleryModule, NgbNavModule, RouterModule, SpkDropdowns, SpkNgSelect, SpkProfileTimeline],
...
export class Profile {
  ...
  users = [
    ...
    {
      id: 7,
      name: 'Cedric Kelly', // Second instance from your list
      role: 'App Developer',
  ...
  // Define the data for your dropdown
  languages = [
    { id: 1, name: 'Us English' },
    { id: 2, name: 'Arabic' },
    { id: 3, name: 'Korean' }
  ];

  // Optional: variable to hold the selected value
  selectedLanguage: number[] = [];

  timelineImages: string[][] = [
    ['./assets/images/media/media-91.jpg', './assets/images/media/media-92.jpg'],
    ['./assets/images/media/media-94.jpg', './assets/images/media/media-91.jpg'],
    [],
    ['./assets/images/media/media-94.jpg', './assets/images/media/media-93.jpg'],
  ...
  selectedTimezone: string = 'Asia/Kolkata'; // Example default
}
