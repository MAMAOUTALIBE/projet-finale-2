...
import * as prismCode from '../../../shared/data/prism/ui-elements/popovers';
...
@Component({
    ...
    imports: [ NgbPopoverModule, ShowcodeCard, SpkPopovers],
...
export class Popovers {
  ...
  DismisablePopover = [
    { id: 1, header: 'Dismissible popover', title: "popover Dismiss", placement: 'top', content: "And here's some amazing content. It's very engaging. Right?", color: "btn btn-primary m-1" },
    { id: 2, header: 'Dismissible popover', title: "popover Dismiss", placement: 'end', content: "And here's some amazing content. It's very engaging. Right?", color: "btn btn-secondary m-1" },
    { id: 3, header: 'Dismissible popover', title: "popover Dismiss", placement: 'bottom', content: "And here's some amazing content. It's very engaging. Right?", color: "btn btn-info m-1" },
    { id: 4, header: 'Dismissible popover', title: "popover Dismiss", placement: 'start', content: "And here's some amazing content. It's very engaging. Right?", color: "btn btn-warning m-1" },
  ]
  SvgPopover = [
    {
      placement:'top',
