...
@Component({
  ...
  imports: [RouterModule, NgbDropdownModule, SpkProgressbar, SvgReplaceDirective, SpkDropdowns],
...
export class FileManager {
  ...
  openWindowCustomClass(content: TemplateRef<HTMLElement>) {
  ...
  categories = [
    {
      name: 'Image',
      size: '14.2 MB',
      svg: `<svg class="file-manager-icon me-2" xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24"
                  viewBox="0 0 24 24">
                  <path fill="#fbb8c7"
    ...
    },
    {
      name: 'Docs',
      size: '34 MB',
      svg: `<svg class="file-manager-icon me-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
  ...
  navItems = [
    { icon: 'fe fe-image', label: 'Images', active: true },
    { icon: 'fe fe-music', label: 'Music' },
    { icon: 'fe fe-video', label: 'Videos' },
    { icon: 'fe fe-smartphone', label: 'APKS' },
    { icon: 'fe fe-download', label: 'Downloads' },
    { icon: 'fe fe-heart', label: 'Favourites' },
    { icon: 'fe fe-eye', label: 'Hidden Files' },
    { icon: 'fe fe-share', label: 'Transfer files' },
    { icon: 'fe fe-database', label: 'Google Drive' },
    { icon: 'fe fe-airplay', label: 'FTP' },
    { icon: 'fe fe-lock', label: 'Private Files' },
    { icon: 'fe fe-wind', label: 'Deep Clean' },
    { icon: 'fe fe-grid', label: 'More' }
  ];
  ...
  files = [
    ...
    { id: 3, name: 'Sea', size: '8.97mb', icon: './assets/images/files/image.png' },
    { id: 4, name: 'Downloads', size: '453kb', icon: './assets/images/files/folder.png', isFolder: true },
    { id: 5, name: 'document.pdf', size: '23kb', icon: './assets/images/files/file.png' },
    { id: 6, name: 'document.pdf', size: '23kb', icon: './assets/images/files/file.png' },
    { id: 7, name: 'Word document', size: '23kb', icon: './assets/images/files/word.png' },
    { id: 8, name: 'document.pdf', size: '23kb', icon: './assets/images/files/file.png' },
    { id: 9, name: 'Outdoor Image', size: '23kb', icon: './assets/images/files/image.png' },
    { id: 10, name: 'document.pdf', size: '23kb', icon: './assets/images/files/file.png' },
    { id: 11, name: 'Downloads', size: '453kb', icon: './assets/images/files/folder.png', isFolder: true },
    { id: 12, name: 'document.pdf', size: '23kb', icon: './assets/images/files/file.png' },
  ];
}
